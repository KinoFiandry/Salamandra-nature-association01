...
const translations: Record<Language, Record<string, string>> = {
    en: {
      ...
      'events.search': 'Search Events',
        ...
        'admin.add.video': 'Add Video',
        'admin.manage.photos': 'Manage Photos',
        'admin.add.photo': 'Add Photo',
        'admin.manage.partners': 'Manage Partners',
        'admin.add.partner': 'Add Partner',
        ...
        'admin.table.donor': 'Donor',
        'admin.table.amount': 'Amount',
        'admin.table.status': 'Status',
        'admin.empty.history': 'No history records found.',
        'admin.empty.logs': 'No system logs found.',
        'admin.empty.donations': 'No donation records yet.',
        'admin.totalReceived': 'Total Received',
        'admin.anonymous': 'Anonymous',
        'admin.login.title': 'Salamandra Admin',
        'admin.login.subtitle': 'Sign in to manage the website',
        ...
        'admin.login.error.generic': 'An error occurred. Please try again.',
        'admin.login.footer': 'Salamandra Nature - Admin Portal',
        'admin.form.titleEn': 'Title (EN)',
        'admin.form.titleFr': 'Title (FR)',
        'admin.form.date': 'Date',
        'admin.form.locationEn': 'Location (EN)',
        'admin.form.descriptionEn': 'Description (EN)',
        'admin.form.descriptionFr': 'Description (FR)',
        'admin.form.cancel': 'Cancel',
        'admin.form.saveEvent': 'Save Event',
        'admin.form.videoUrl': 'Video URL (YouTube/Vimeo)',
        'admin.form.thumbnailUrl': 'Thumbnail URL',
        'admin.form.category': 'Category',
        'admin.form.saveVideo': 'Save Video',
        'admin.form.photoFile': 'Photo File',
        'admin.form.photoClick': 'Click to upload photo',
        'admin.form.photoSize': 'JPG, PNG, GIF up to 10MB',
        'admin.form.captionEn': 'Caption (EN)',
        'admin.form.captionFr': 'Caption (FR)',
        'admin.form.uploading': 'Uploading...',
        'admin.form.uploadPhoto': 'Upload Photo',
        'admin.form.partnerName': 'Partner Name',
        'admin.form.websiteUrl': 'Website URL',
        'admin.form.logoUrl': 'Logo URL',
        'admin.form.type': 'Type',
        'admin.form.savePartner': 'Save Partner',
          'admin.tabs.members': 'Members',
          'admin.tabs.news': 'News',
          'admin.tabs.projects': 'Projects',
          'admin.manage.members': 'Manage Team Members',
          ...
          'admin.edit.member': 'Edit Member',
          'admin.edit.news': 'Edit News',
          'admin.edit.project': 'Edit Project',
          'admin.form.memberName': 'Member Name',
          'admin.form.roleEn': 'Role (EN)',
          'admin.form.roleFr': 'Role (FR)',
          'admin.form.bioEn': 'Bio (EN)',
          'admin.form.bioFr': 'Bio (FR)',
          'admin.form.displayOrder': 'Display Order',
          'admin.form.saveMember': 'Save Member',
          'admin.form.contentEn': 'Content (EN)',
          'admin.form.contentFr': 'Content (FR)',
          'admin.form.imageUrl': 'Image URL',
          'admin.form.saveNews': 'Save News',
          'admin.form.saveProject': 'Save Project',
          'admin.form.categoryEn': 'Category (EN)',
          'admin.form.categoryFr': 'Category (FR)',
    ...
    fr: {
      ...
      'events.search': 'Rechercher des Événements',
        ...
        'admin.manageContent': 'Gérer le Contenu du Site de l\'ONG',
        'admin.totalVisitors': 'Total des Visiteurs',
        'admin.logout': 'Déconnexion',
        'admin.goWebsite': 'Aller sur le Site',
        'admin.tabs.events': 'Événements',
        'admin.tabs.videos': 'Vidéos',
        'admin.tabs.photos': 'Photos',
        'admin.tabs.partners': 'Partenaires',
        'admin.tabs.history': 'Historique',
        'admin.tabs.logs': 'Journaux',
        'admin.tabs.donations': 'Dons',
        'admin.manage.events': 'Gérer les Événements',
        'admin.add.event': 'Ajouter un Événement',
        'admin.manage.videos': 'Gérer les Vidéos',
        'admin.add.video': 'Ajouter une Vidéo',
        'admin.manage.photos': 'Gérer les Photos',
        'admin.add.photo': 'Ajouter une Photo',
        'admin.manage.partners': 'Gérer les Partenaires',
        'admin.add.partner': 'Ajouter un Partenaire',
        ...
        'admin.table.message': 'Message',
        'admin.table.donor': 'Donateur',
        'admin.table.amount': 'Montant',
        'admin.table.status': 'Statut',
        'admin.empty.history': 'Aucun historique trouvé.',
        'admin.empty.logs': 'Aucun journal système trouvé.',
        'admin.empty.donations': 'Aucun don enregistré.',
        'admin.totalReceived': 'Total Reçu',
        'admin.anonymous': 'Anonyme',
        'admin.login.title': 'Admin Salamandra',
        'admin.login.subtitle': 'Connectez-vous pour gérer le site',
        'admin.login.username': 'Nom d\'utilisateur',
        'admin.login.password': 'Mot de passe',
        'admin.login.usernamePlaceholder': 'Entrez le nom d\'utilisateur',
        'admin.login.passwordPlaceholder': 'Entrez le mot de passe',
        'admin.login.submit': 'Se Connecter',
        'admin.login.submitting': 'Connexion...',
        'admin.login.error.invalid': 'Nom d\'utilisateur ou mot de passe invalide',
        'admin.login.error.generic': 'Une erreur est survenue. Veuillez réessayer.',
        'admin.login.footer': 'Salamandra Nature - Portail Admin',
        'admin.form.titleEn': 'Titre (EN)',
        'admin.form.titleFr': 'Titre (FR)',
        'admin.form.date': 'Date',
        'admin.form.locationEn': 'Lieu (EN)',
        'admin.form.descriptionEn': 'Description (EN)',
        'admin.form.descriptionFr': 'Description (FR)',
        'admin.form.cancel': 'Annuler',
        'admin.form.saveEvent': 'Enregistrer l\'Événement',
        'admin.form.videoUrl': 'URL de la Vidéo (YouTube/Vimeo)',
        'admin.form.thumbnailUrl': 'URL de la Miniature',
        'admin.form.category': 'Catégorie',
        'admin.form.saveVideo': 'Enregistrer la Vidéo',
        'admin.form.photoFile': 'Fichier Photo',
        'admin.form.photoClick': 'Cliquez pour télécharger la photo',
        'admin.form.photoSize': 'JPG, PNG, GIF jusqu\'à 10Mo',
        'admin.form.captionEn': 'Légende (EN)',
        'admin.form.captionFr': 'Légende (FR)',
        'admin.form.uploading': 'Téléchargement...',
        'admin.form.uploadPhoto': 'Télécharger la Photo',
        'admin.form.partnerName': 'Nom du Partenaire',
        'admin.form.websiteUrl': 'URL du Site',
        'admin.form.logoUrl': 'URL du Logo',
        'admin.form.type': 'Type',
        'admin.form.savePartner': 'Enregistrer le Partenaire',
          'admin.tabs.members': 'Membres',
          'admin.tabs.news': 'Actualités',
          'admin.tabs.projects': 'Projets',
          'admin.manage.members': 'Gérer les Membres',
          'admin.manage.news': 'Gérer les Actualités',
          'admin.manage.projects': 'Gérer les Projets',
          'admin.add.member': 'Ajouter un Membre',
          'admin.add.news': 'Ajouter une Actualité',
          'admin.add.project': 'Ajouter un Projet',
          'admin.edit.member': 'Modifier le Membre',
          'admin.edit.news': 'Modifier l\'Actualité',
          'admin.edit.project': 'Modifier le Projet',
          'admin.form.memberName': 'Nom du Membre',
          'admin.form.roleEn': 'Rôle (EN)',
          'admin.form.roleFr': 'Rôle (FR)',
          'admin.form.bioEn': 'Bio (EN)',
          'admin.form.bioFr': 'Bio (FR)',
          'admin.form.displayOrder': 'Ordre d\'affichage',
          'admin.form.saveMember': 'Enregistrer le Membre',
          'admin.form.contentEn': 'Contenu (EN)',
          'admin.form.contentFr': 'Contenu (FR)',
          'admin.form.imageUrl': 'URL de l\'Image',
          'admin.form.saveNews': 'Enregistrer l\'Actualité',
          'admin.form.saveProject': 'Enregistrer le Projet',
          'admin.form.categoryEn': 'Catégorie (EN)',
          'admin.form.categoryFr': 'Catégorie (FR)',
        'donate.thanks': 'Merci !',
