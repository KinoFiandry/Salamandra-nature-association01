...
const translations: Record<Language, Record<string, string>> = {
    en: {
      'nav.home': 'Home',
      'nav.about': 'About Us',
      'nav.about.presentation': 'General Presentation',
      'nav.about.actions': 'Our Actions',
      'nav.about.docs': 'Our Doc',
      ...
      'about.reports': 'Our Reports',
      'about.reports.download': 'Download PDF',
      'about.reports.openPdf': 'Open PDF',
      'admin.tabs.reports': 'Reports',
      'admin.reports.manage': 'Manage Reports',
      'admin.reports.add': 'Add Report',
      'admin.reports.edit': 'Edit Report',
      'admin.reports.titleEn': 'Title (EN)',
      'admin.reports.titleFr': 'Title (FR)',
      'admin.reports.descEn': 'Description (EN)',
      'admin.reports.descFr': 'Description (FR)',
      'admin.reports.year': 'Year',
      'admin.reports.fileUrl': 'PDF File URL',
      'admin.reports.uploadPdf': 'Upload PDF',
      'admin.reports.save': 'Save Report',
      'admin.reports.deleteConfirm': 'Are you sure you want to delete this report?',
      'admin.reports.empty': 'No reports yet. Add your first report!',
    ...
    fr: {
      'nav.home': 'Accueil',
      'nav.about': 'À Propos',
      'nav.about.presentation': 'Présentation générale',
      'nav.about.actions': 'Nos Actions',
      'nav.about.docs': 'Nos Documents',
      ...
      'about.reports': 'Nos Rapports',
      'about.reports.download': 'Télécharger le PDF',
      'about.reports.openPdf': 'Ouvrir le PDF',
      'admin.tabs.reports': 'Rapports',
      'admin.reports.manage': 'Gérer les Rapports',
      'admin.reports.add': 'Ajouter un Rapport',
      'admin.reports.edit': 'Modifier le Rapport',
      'admin.reports.titleEn': 'Titre (EN)',
      'admin.reports.titleFr': 'Titre (FR)',
      'admin.reports.descEn': 'Description (EN)',
      'admin.reports.descFr': 'Description (FR)',
      'admin.reports.year': 'Année',
      'admin.reports.fileUrl': 'URL du fichier PDF',
      'admin.reports.uploadPdf': 'Téléverser le PDF',
      'admin.reports.save': 'Enregistrer le Rapport',
      'admin.reports.deleteConfirm': 'Êtes-vous sûr de vouloir supprimer ce rapport ?',
      'admin.reports.empty': 'Aucun rapport pour l\'instant. Ajoutez votre premier rapport !',
