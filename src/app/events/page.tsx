            ...
            <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-emerald-100">
              <div className="relative mb-6">
                ...
                <Input
                  ...
                  className="pl-10 h-12 rounded-xl border-emerald-100 focus:ring-emerald-500"
                />
              </div>
              <Calendar
                mode="single"
          ...
          <div className="space-y-6">
            ...
            {loading ? (
              ...
              <div className="grid gap-6">
                {filteredEvents.map((event) => (
                  <motion.div
                    ...
                    className="bg-white p-8 rounded-[2rem] shadow-sm border border-emerald-100 hover:shadow-md transition-shadow group"
                  >
                    <div className="flex flex-col md:flex-row md:items-center gap-6">
                      <div className="w-20 h-20 bg-emerald-50 rounded-2xl flex flex-col items-center justify-center text-emerald-600 border border-emerald-100 shrink-0">
                      ...
                      <button className="bg-emerald-50 text-emerald-600 px-6 py-3 rounded-xl font-bold group-hover:bg-emerald-600 group-hover:text-white transition-all self-start md:self-center">
                        Details
                      </button>
                    </div>
                  </motion.div>
              ...
              <div className="bg-white p-20 rounded-[2rem] border border-emerald-100 text-center">
                <CalendarIcon className="w-16 h-16 text-emerald-100 mx-auto mb-6" />
